# 03-Kubectl-Commands-Cheat Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **Kubernetes**.

## 📋 Descrição do Projeto
03 kubectl commands cheat focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
