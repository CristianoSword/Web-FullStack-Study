# 04-Kubernetes-Service-NodePort Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **Kubernetes**.

## 📋 Descrição do Projeto
04 kubernetes service nodeport focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
