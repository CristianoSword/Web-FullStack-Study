# 01-Minikube-Cluster-Setup Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **Kubernetes**.

## 📋 Descrição do Projeto
01 minikube cluster setup focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
