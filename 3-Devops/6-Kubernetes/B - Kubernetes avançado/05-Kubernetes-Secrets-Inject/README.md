# 05-Kubernetes-Secrets-Inject Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **Kubernetes**.

## 📋 Descrição do Projeto
05 kubernetes secrets inject focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
