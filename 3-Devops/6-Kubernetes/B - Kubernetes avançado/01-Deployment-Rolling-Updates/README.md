# 01-Deployment-Rolling-Updates Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **Kubernetes**.

## 📋 Descrição do Projeto
01 deployment rolling updates focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
