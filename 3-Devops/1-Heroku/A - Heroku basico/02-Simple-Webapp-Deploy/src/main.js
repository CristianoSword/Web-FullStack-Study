...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "02-Simple-Webapp-Deploy" });
...
server.listen(PORT, () => {
  console.log(`02-Simple-Webapp-Deploy laboratory running on port ${PORT}`);
});
