...
console.log("Running integration sanity tests for 02-Simple-Webapp-Deploy...");

try {
  assert.strictEqual(AppConfigSchema.service, "02-Simple-Webapp-Deploy");
  
  const engine = new CoreEngine({ service: "02-Simple-Webapp-Deploy" });
