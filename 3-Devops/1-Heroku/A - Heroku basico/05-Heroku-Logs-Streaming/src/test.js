...
console.log("Running integration sanity tests for 05-Heroku-Logs-Streaming...");

try {
  assert.strictEqual(AppConfigSchema.service, "05-Heroku-Logs-Streaming");
  
  const engine = new CoreEngine({ service: "05-Heroku-Logs-Streaming" });
