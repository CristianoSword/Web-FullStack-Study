...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "05-Heroku-Logs-Streaming" });
...
server.listen(PORT, () => {
  console.log(`05-Heroku-Logs-Streaming laboratory running on port ${PORT}`);
});
