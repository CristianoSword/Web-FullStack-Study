# 05-Heroku-Logs-Streaming Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **Heroku**.

## 📋 Descrição do Projeto
05 heroku logs streaming focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
