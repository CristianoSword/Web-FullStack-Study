# 03-Environment-Config-Vars Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **Heroku**.

## 📋 Descrição do Projeto
03 environment config vars focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
