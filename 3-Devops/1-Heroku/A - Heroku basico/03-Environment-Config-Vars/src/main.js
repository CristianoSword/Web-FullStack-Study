...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "03-Environment-Config-Vars" });
...
server.listen(PORT, () => {
  console.log(`03-Environment-Config-Vars laboratory running on port ${PORT}`);
});
