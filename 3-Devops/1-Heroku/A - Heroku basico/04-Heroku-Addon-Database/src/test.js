...
console.log("Running integration sanity tests for 04-Heroku-Addon-Database...");

try {
  assert.strictEqual(AppConfigSchema.service, "04-Heroku-Addon-Database");
  
  const engine = new CoreEngine({ service: "04-Heroku-Addon-Database" });
