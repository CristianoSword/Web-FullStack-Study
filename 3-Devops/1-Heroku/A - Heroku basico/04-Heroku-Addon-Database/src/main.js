...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "04-Heroku-Addon-Database" });
...
server.listen(PORT, () => {
  console.log(`04-Heroku-Addon-Database laboratory running on port ${PORT}`);
});
