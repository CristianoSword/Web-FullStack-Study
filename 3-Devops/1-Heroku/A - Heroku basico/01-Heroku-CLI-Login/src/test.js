...
console.log("Running integration sanity tests for 01-Heroku-CLI-Login...");

try {
  assert.strictEqual(AppConfigSchema.service, "01-Heroku-CLI-Login");
  
  const engine = new CoreEngine({ service: "01-Heroku-CLI-Login" });
