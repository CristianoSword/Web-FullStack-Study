...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "05-Heroku-SSL-Custom-Domain" });
...
server.listen(PORT, () => {
  console.log(`05-Heroku-SSL-Custom-Domain laboratory running on port ${PORT}`);
});
