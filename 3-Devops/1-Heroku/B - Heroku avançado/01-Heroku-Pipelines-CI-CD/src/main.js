...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "01-Heroku-Pipelines-CI-CD" });
...
server.listen(PORT, () => {
  console.log(`01-Heroku-Pipelines-CI-CD laboratory running on port ${PORT}`);
});
