# 01-Heroku-Pipelines-CI-CD Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **Heroku**.

## 📋 Descrição do Projeto
01 heroku pipelines ci cd focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
