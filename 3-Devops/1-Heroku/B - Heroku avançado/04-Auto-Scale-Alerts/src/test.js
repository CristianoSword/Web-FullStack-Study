...
console.log("Running integration sanity tests for 04-Auto-Scale-Alerts...");

try {
  assert.strictEqual(AppConfigSchema.service, "04-Auto-Scale-Alerts");
  
  const engine = new CoreEngine({ service: "04-Auto-Scale-Alerts" });
