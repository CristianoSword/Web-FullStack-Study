...
console.log("Running integration sanity tests for 02-Docker-Deploy-Container...");

try {
  assert.strictEqual(AppConfigSchema.service, "02-Docker-Deploy-Container");
  
  const engine = new CoreEngine({ service: "02-Docker-Deploy-Container" });
