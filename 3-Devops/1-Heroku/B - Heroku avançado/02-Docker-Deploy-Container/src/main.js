...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "02-Docker-Deploy-Container" });
...
server.listen(PORT, () => {
  console.log(`02-Docker-Deploy-Container laboratory running on port ${PORT}`);
});
