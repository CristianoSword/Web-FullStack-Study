# 03-Custom-Buildpack-Integration Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **Heroku**.

## 📋 Descrição do Projeto
03 custom buildpack integration focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
