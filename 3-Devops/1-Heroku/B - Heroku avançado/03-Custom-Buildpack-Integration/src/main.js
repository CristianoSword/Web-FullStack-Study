...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "03-Custom-Buildpack-Integration" });
...
server.listen(PORT, () => {
  console.log(`03-Custom-Buildpack-Integration laboratory running on port ${PORT}`);
});
