...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "03-Pub-Sub-Message-Streaming" });
...
server.listen(PORT, () => {
  console.log(`03-Pub-Sub-Message-Streaming laboratory running on port ${PORT}`);
});
