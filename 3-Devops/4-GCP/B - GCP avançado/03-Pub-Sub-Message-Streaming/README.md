# 03-Pub-Sub-Message-Streaming Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **GCP**.

## 📋 Descrição do Projeto
03 pub sub message streaming focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
