# 05-GCP-IAM-Service-Account Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **GCP**.

## 📋 Descrição do Projeto
05 gcp iam service account focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
