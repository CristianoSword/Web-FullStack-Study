...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "05-GCP-IAM-Service-Account" });
...
server.listen(PORT, () => {
  console.log(`05-GCP-IAM-Service-Account laboratory running on port ${PORT}`);
});
