...
console.log("Running integration sanity tests for 05-GCP-IAM-Service-Account...");

try {
  assert.strictEqual(AppConfigSchema.service, "05-GCP-IAM-Service-Account");
  
  const engine = new CoreEngine({ service: "05-GCP-IAM-Service-Account" });
