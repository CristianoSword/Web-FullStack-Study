# 04-Cloud-Functions-Trigger Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **GCP**.

## 📋 Descrição do Projeto
04 cloud functions trigger focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
