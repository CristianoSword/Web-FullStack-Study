...
console.log("Running integration sanity tests for 04-Cloud-Functions-Trigger...");

try {
  assert.strictEqual(AppConfigSchema.service, "04-Cloud-Functions-Trigger");
  
  const engine = new CoreEngine({ service: "04-Cloud-Functions-Trigger" });
