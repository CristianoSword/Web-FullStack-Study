...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "04-Cloud-Functions-Trigger" });
...
server.listen(PORT, () => {
  console.log(`04-Cloud-Functions-Trigger laboratory running on port ${PORT}`);
});
