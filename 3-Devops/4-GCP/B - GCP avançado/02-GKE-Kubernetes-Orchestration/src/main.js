...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "02-GKE-Kubernetes-Orchestration" });
...
server.listen(PORT, () => {
  console.log(`02-GKE-Kubernetes-Orchestration laboratory running on port ${PORT}`);
});
