# 02-GKE-Kubernetes-Orchestration Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **GCP**.

## 📋 Descrição do Projeto
02 gke kubernetes orchestration focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
