# 01-Cloud-Run-Serverless-Containers Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **GCP**.

## 📋 Descrição do Projeto
01 cloud run serverless containers focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
