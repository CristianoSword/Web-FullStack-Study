...
console.log("Running integration sanity tests for 03-Cloud-Storage-Bucket...");

try {
  assert.strictEqual(AppConfigSchema.service, "03-Cloud-Storage-Bucket");
  
  const engine = new CoreEngine({ service: "03-Cloud-Storage-Bucket" });
