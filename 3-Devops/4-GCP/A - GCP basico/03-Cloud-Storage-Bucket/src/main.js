...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "03-Cloud-Storage-Bucket" });
...
server.listen(PORT, () => {
  console.log(`03-Cloud-Storage-Bucket laboratory running on port ${PORT}`);
});
