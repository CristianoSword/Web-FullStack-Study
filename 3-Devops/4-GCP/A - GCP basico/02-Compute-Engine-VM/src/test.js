...
console.log("Running integration sanity tests for 02-Compute-Engine-VM...");

try {
  assert.strictEqual(AppConfigSchema.service, "02-Compute-Engine-VM");
  
  const engine = new CoreEngine({ service: "02-Compute-Engine-VM" });
