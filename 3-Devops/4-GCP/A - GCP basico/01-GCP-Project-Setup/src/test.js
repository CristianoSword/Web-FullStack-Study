...
console.log("Running integration sanity tests for 01-GCP-Project-Setup...");

try {
  assert.strictEqual(AppConfigSchema.service, "01-GCP-Project-Setup");
  
  const engine = new CoreEngine({ service: "01-GCP-Project-Setup" });
