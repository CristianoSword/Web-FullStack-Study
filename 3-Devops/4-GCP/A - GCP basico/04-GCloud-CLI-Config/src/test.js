...
console.log("Running integration sanity tests for 04-GCloud-CLI-Config...");

try {
  assert.strictEqual(AppConfigSchema.service, "04-GCloud-CLI-Config");
  
  const engine = new CoreEngine({ service: "04-GCloud-CLI-Config" });
