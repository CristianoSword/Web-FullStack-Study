...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "03-Auto-Scaling-ELB-Stack" });
...
server.listen(PORT, () => {
  console.log(`03-Auto-Scaling-ELB-Stack laboratory running on port ${PORT}`);
});
