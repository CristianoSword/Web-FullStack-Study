...
console.log("Running integration sanity tests for 03-Auto-Scaling-ELB-Stack...");

try {
  assert.strictEqual(AppConfigSchema.service, "03-Auto-Scaling-ELB-Stack");
  
  const engine = new CoreEngine({ service: "03-Auto-Scaling-ELB-Stack" });
