# 03-Auto-Scaling-ELB-Stack Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **AWS**.

## 📋 Descrição do Projeto
03 auto scaling elb stack focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
