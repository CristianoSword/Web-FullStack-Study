# 05-ECS-Fargate-Containers Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **AWS**.

## 📋 Descrição do Projeto
05 ecs fargate containers focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
