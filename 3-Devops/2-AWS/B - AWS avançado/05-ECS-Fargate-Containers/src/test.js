...
console.log("Running integration sanity tests for 05-ECS-Fargate-Containers...");

try {
  assert.strictEqual(AppConfigSchema.service, "05-ECS-Fargate-Containers");
  
  const engine = new CoreEngine({ service: "05-ECS-Fargate-Containers" });
