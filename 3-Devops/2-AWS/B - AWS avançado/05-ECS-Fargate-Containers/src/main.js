...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "05-ECS-Fargate-Containers" });
...
server.listen(PORT, () => {
  console.log(`05-ECS-Fargate-Containers laboratory running on port ${PORT}`);
});
