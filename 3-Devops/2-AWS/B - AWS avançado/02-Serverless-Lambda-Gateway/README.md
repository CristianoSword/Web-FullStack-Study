# 02-Serverless-Lambda-Gateway Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **AWS**.

## 📋 Descrição do Projeto
02 serverless lambda gateway focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
