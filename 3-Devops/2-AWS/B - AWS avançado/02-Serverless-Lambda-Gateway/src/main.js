...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "02-Serverless-Lambda-Gateway" });
...
server.listen(PORT, () => {
  console.log(`02-Serverless-Lambda-Gateway laboratory running on port ${PORT}`);
});
