...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "01-VPC-Network-Architecture" });
...
server.listen(PORT, () => {
  console.log(`01-VPC-Network-Architecture laboratory running on port ${PORT}`);
});
