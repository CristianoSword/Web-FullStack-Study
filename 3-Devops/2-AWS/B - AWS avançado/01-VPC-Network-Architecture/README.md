# 01-VPC-Network-Architecture Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **AWS**.

## 📋 Descrição do Projeto
01 vpc network architecture focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
