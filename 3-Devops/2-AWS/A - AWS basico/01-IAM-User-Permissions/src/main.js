...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "01-IAM-User-Permissions" });
...
server.listen(PORT, () => {
  console.log(`01-IAM-User-Permissions laboratory running on port ${PORT}`);
});
