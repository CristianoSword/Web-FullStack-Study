...
console.log("Running integration sanity tests for 04-AWS-CLI-Setup...");

try {
  assert.strictEqual(AppConfigSchema.service, "04-AWS-CLI-Setup");
  
  const engine = new CoreEngine({ service: "04-AWS-CLI-Setup" });
