...
console.log("Running integration sanity tests for 03-S3-Bucket-Storage...");

try {
  assert.strictEqual(AppConfigSchema.service, "03-S3-Bucket-Storage");
  
  const engine = new CoreEngine({ service: "03-S3-Bucket-Storage" });
