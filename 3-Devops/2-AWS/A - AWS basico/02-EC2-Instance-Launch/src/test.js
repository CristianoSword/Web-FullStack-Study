...
console.log("Running integration sanity tests for 02-EC2-Instance-Launch...");

try {
  assert.strictEqual(AppConfigSchema.service, "02-EC2-Instance-Launch");
  
  const engine = new CoreEngine({ service: "02-EC2-Instance-Launch" });
