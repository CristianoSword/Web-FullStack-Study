...
console.log("Running integration sanity tests for 05-RDS-Database-Setup...");

try {
  assert.strictEqual(AppConfigSchema.service, "05-RDS-Database-Setup");
  
  const engine = new CoreEngine({ service: "05-RDS-Database-Setup" });
