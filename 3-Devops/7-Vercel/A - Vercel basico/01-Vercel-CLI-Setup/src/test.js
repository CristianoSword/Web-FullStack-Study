...
console.log("Running integration sanity tests for 01-Vercel-CLI-Setup...");

try {
  assert.strictEqual(AppConfigSchema.service, "01-Vercel-CLI-Setup");
  
  const engine = new CoreEngine({ service: "01-Vercel-CLI-Setup" });
