...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "03-Redirects-Headers-Config" });
...
server.listen(PORT, () => {
  console.log(`03-Redirects-Headers-Config laboratory running on port ${PORT}`);
});
