...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "04-Project-Variables-Dashboard" });
...
server.listen(PORT, () => {
  console.log(`04-Project-Variables-Dashboard laboratory running on port ${PORT}`);
});
