# 04-Project-Variables-Dashboard Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **Vercel**.

## 📋 Descrição do Projeto
04 project variables dashboard focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
