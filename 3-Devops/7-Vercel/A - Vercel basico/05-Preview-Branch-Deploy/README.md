# 05-Preview-Branch-Deploy Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **Vercel**.

## 📋 Descrição do Projeto
05 preview branch deploy focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
