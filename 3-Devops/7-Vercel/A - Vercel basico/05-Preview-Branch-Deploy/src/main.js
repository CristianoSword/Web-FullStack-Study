...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "05-Preview-Branch-Deploy" });
...
server.listen(PORT, () => {
  console.log(`05-Preview-Branch-Deploy laboratory running on port ${PORT}`);
});
