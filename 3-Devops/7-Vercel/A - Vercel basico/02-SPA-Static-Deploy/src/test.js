...
console.log("Running integration sanity tests for 02-SPA-Static-Deploy...");

try {
  assert.strictEqual(AppConfigSchema.service, "02-SPA-Static-Deploy");
  
  const engine = new CoreEngine({ service: "02-SPA-Static-Deploy" });
