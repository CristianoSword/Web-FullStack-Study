...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "04-Analytics-Speed-Insights" });
...
server.listen(PORT, () => {
  console.log(`04-Analytics-Speed-Insights laboratory running on port ${PORT}`);
});
