...
console.log("Running integration sanity tests for 05-Monorepo-Custom-Build...");

try {
  assert.strictEqual(AppConfigSchema.service, "05-Monorepo-Custom-Build");
  
  const engine = new CoreEngine({ service: "05-Monorepo-Custom-Build" });
