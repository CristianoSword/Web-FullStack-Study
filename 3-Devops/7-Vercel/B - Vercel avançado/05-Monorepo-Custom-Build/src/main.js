...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "05-Monorepo-Custom-Build" });
...
server.listen(PORT, () => {
  console.log(`05-Monorepo-Custom-Build laboratory running on port ${PORT}`);
});
