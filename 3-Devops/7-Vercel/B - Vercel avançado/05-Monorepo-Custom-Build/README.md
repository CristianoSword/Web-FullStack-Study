# 05-Monorepo-Custom-Build Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **Vercel**.

## 📋 Descrição do Projeto
05 monorepo custom build focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
