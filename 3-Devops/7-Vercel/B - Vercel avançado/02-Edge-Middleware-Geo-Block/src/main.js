...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "02-Edge-Middleware-Geo-Block" });
...
server.listen(PORT, () => {
  console.log(`02-Edge-Middleware-Geo-Block laboratory running on port ${PORT}`);
});
