# 02-Edge-Middleware-Geo-Block Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **Vercel**.

## 📋 Descrição do Projeto
02 edge middleware geo block focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
