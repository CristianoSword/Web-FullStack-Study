...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "01-Vercel-Serverless-Functions" });
...
server.listen(PORT, () => {
  console.log(`01-Vercel-Serverless-Functions laboratory running on port ${PORT}`);
});
