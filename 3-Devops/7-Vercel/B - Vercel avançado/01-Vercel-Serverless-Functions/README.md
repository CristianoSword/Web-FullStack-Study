# 01-Vercel-Serverless-Functions Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **Vercel**.

## 📋 Descrição do Projeto
01 vercel serverless functions focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
