# 03-GitHub-Actions-Environment-Variables Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **GitHub Actions**.

## 📋 Descrição do Projeto
03 github actions environment variables focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
