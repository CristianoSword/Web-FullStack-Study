# 03-Custom-Action-Development Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **GitHub Actions**.

## 📋 Descrição do Projeto
03 custom action development focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
