# 02-Linter-Automated-Check Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **GitHub Actions**.

## 📋 Descrição do Projeto
02 linter automated check focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
