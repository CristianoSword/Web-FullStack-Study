# 05-Conditional-Steps-Exec Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **GitHub Actions**.

## 📋 Descrição do Projeto
05 conditional steps exec focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
