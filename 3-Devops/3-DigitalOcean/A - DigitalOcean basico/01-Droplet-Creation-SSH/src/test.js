...
console.log("Running integration sanity tests for 01-Droplet-Creation-SSH...");

try {
  assert.strictEqual(AppConfigSchema.service, "01-Droplet-Creation-SSH");
  
  const engine = new CoreEngine({ service: "01-Droplet-Creation-SSH" });
