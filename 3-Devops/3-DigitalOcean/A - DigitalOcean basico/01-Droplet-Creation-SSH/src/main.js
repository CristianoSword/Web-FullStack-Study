...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "01-Droplet-Creation-SSH" });
...
server.listen(PORT, () => {
  console.log(`01-Droplet-Creation-SSH laboratory running on port ${PORT}`);
});
