# 04-DO-App-Platform-Deploy Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **DigitalOcean**.

## 📋 Descrição do Projeto
04 do app platform deploy focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
