...
console.log("Running integration sanity tests for 04-DO-App-Platform-Deploy...");

try {
  assert.strictEqual(AppConfigSchema.service, "04-DO-App-Platform-Deploy");
  
  const engine = new CoreEngine({ service: "04-DO-App-Platform-Deploy" });
