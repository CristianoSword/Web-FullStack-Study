...
console.log("Running integration sanity tests for 02-Nginx-Reverse-Proxy...");

try {
  assert.strictEqual(AppConfigSchema.service, "02-Nginx-Reverse-Proxy");
  
  const engine = new CoreEngine({ service: "02-Nginx-Reverse-Proxy" });
