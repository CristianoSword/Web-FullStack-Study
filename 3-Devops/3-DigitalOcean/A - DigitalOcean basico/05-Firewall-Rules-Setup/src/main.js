...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "05-Firewall-Rules-Setup" });
...
server.listen(PORT, () => {
  console.log(`05-Firewall-Rules-Setup laboratory running on port ${PORT}`);
});
