...
console.log("Running integration sanity tests for 05-Firewall-Rules-Setup...");

try {
  assert.strictEqual(AppConfigSchema.service, "05-Firewall-Rules-Setup");
  
  const engine = new CoreEngine({ service: "05-Firewall-Rules-Setup" });
