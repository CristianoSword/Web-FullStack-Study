...
console.log("Running integration sanity tests for 03-Spaces-Object-Storage...");

try {
  assert.strictEqual(AppConfigSchema.service, "03-Spaces-Object-Storage");
  
  const engine = new CoreEngine({ service: "03-Spaces-Object-Storage" });
