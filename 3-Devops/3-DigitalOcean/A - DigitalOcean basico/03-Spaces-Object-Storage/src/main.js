...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "03-Spaces-Object-Storage" });
...
server.listen(PORT, () => {
  console.log(`03-Spaces-Object-Storage laboratory running on port ${PORT}`);
});
