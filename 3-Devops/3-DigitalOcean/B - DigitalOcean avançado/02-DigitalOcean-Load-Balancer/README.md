# 02-DigitalOcean-Load-Balancer Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **DigitalOcean**.

## 📋 Descrição do Projeto
02 digitalocean load balancer focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
