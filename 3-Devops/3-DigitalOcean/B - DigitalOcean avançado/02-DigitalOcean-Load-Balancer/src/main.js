...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "02-DigitalOcean-Load-Balancer" });
...
server.listen(PORT, () => {
  console.log(`02-DigitalOcean-Load-Balancer laboratory running on port ${PORT}`);
});
