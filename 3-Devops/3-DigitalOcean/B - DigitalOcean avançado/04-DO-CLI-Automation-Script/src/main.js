...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "04-DO-CLI-Automation-Script" });
...
server.listen(PORT, () => {
  console.log(`04-DO-CLI-Automation-Script laboratory running on port ${PORT}`);
});
