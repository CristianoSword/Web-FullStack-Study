# 04-DO-CLI-Automation-Script Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **DigitalOcean**.

## 📋 Descrição do Projeto
04 do cli automation script focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
