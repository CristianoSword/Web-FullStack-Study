# 03-DOKS-Kubernetes-Cluster Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **DigitalOcean**.

## 📋 Descrição do Projeto
03 doks kubernetes cluster focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
