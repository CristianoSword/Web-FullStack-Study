...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "03-DOKS-Kubernetes-Cluster" });
...
server.listen(PORT, () => {
  console.log(`03-DOKS-Kubernetes-Cluster laboratory running on port ${PORT}`);
});
