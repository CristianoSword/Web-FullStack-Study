...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "01-Managed-Database-Cluster" });
...
server.listen(PORT, () => {
  console.log(`01-Managed-Database-Cluster laboratory running on port ${PORT}`);
});
