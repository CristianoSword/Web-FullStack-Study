# 05-Continuous-Integration-Actions Laboratory

Este laboratório faz parte dos estudos fullstack voltados para **DigitalOcean**.

## 📋 Descrição do Projeto
05 continuous integration actions focado em implementar práticas recomendadas de DevOps, otimização e arquiteturas escaláveis.
