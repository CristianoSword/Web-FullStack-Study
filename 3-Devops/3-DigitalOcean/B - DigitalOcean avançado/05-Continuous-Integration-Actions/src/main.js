...
const engine = new CoreEngine({ service: process.env.SERVICE_NAME || "05-Continuous-Integration-Actions" });
...
server.listen(PORT, () => {
  console.log(`05-Continuous-Integration-Actions laboratory running on port ${PORT}`);
});
